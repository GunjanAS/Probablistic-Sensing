...
def main_a7(a67obj):
    ...
    while True:
        ...
        if examine_current_cell(curr_cell, a67obj):
            print("Total number of actions for agent 7 are ",
        ...
        while True:
            ...
            for i in path[::-1]:
                ##execute the path
                movements += 1
                if(a67obj.original_grid[i[0]][i[1]] == 0): #bumped into a blocked cell, update the belief matrix and success_finding_matrix
